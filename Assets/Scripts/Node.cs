...
public class Node : IComparable<Node>
{
    ...
    public List<Node> Neighbors(bool avoidCities, bool onlyRoads)
    {
        ...
        else
        {
            //left
            if (Point.X > 0)
                if (World.Constructions[Point.X - 1, Point.Y] != null && (World.Constructions[Point.X - 1, Point.Y].GetType() == typeof(Road) || World.Constructions[Point.X - 1, Point.Y].GetType() == typeof(City)))
            ...
            //up
            if (Point.Y < World.height - 1)
                if (World.Constructions[Point.X, Point.Y + 1] != null && (World.Constructions[Point.X, Point.Y + 1].GetType() == typeof(Road) || World.Constructions[Point.X, Point.Y + 1].GetType() == typeof(City)))
